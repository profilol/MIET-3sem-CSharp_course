...
namespace Lab_02
{
    class ResearchTeam: Team, IEnumerable
    {
        ...
        private ArrayList _researchers = new ArrayList();
        private ArrayList _publicationList = new ArrayList();
        ...
        public ArrayList publicationList
        {
        ...
        public void AddPapers(Paper[] newPapers)
        {
            ...
            ArrayList oldPublications = this._publicationList;
        ...
        public void AddMembers(Person[] members)
        {
            ...
            ArrayList oldMembers = this.researchers;
